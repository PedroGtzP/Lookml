view: wait_time_us_border {
  sql_table_name: `US_BORDER.wait_time_us_border` ;;
  ...
  dimension: avg_az_vehicles {
    type: number
    sql: ${TABLE}.Avg_AZ_Vehicles ;;
  }
  ...
  dimension: avg_volume {
    type: number
    sql: ${TABLE}.Avg_Volume ;;
  }
  dimension: avg_volume_booth {
    type: number
    sql: ${TABLE}.Avg_Volume_Booth ;;
  }
  ...
  dimension: max_us_other_vehicles {
    type: number
    sql: ${TABLE}.Max_US_Other_Vehicles ;;
  }
  ...
  dimension: min_ak_vehicles {
    type: number
    sql: ${TABLE}.Min_AK_Vehicles ;;
  }
